defmodule MealManagerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MealManagerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MealManagerWeb.Gettext, "errors", msg, opts)
    end
  end
